...
namespace ConnectorLib.usb2snes
{
    ...
    public class RequestType
    {
        ...
        public bool RequiresData() => Opcode == "GetAddress" || Opcode == "GetFile" || Opcode == "List" || Opcode == "Info" || Opcode == "Stream";
        public bool HasData() => Opcode == "PutAddress" || Opcode == "PutFile";
    }
    ...
    public class IPS
    {
        ...
        public class Patch
        {
            ...
            public int Address{ get; set; } // 24b file address

            public Patch() => Data = new List<byte>();
        }

        [NotNull]
        public readonly List<Patch> Items;
        ...
        public void Parse([NotNull] string fileName)
        {
            int index = 0;
